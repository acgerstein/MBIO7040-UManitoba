...
p3 <- ggplot(data = Calb_R, mapping = aes(x = type, y = disk)) +
  ...
  labs(y = "disk diffusion zone of inhibition (mm)" , y = "site of strain isolation") +
  annotate("text",x = c(1, 2, 3), y = c(0, 0, 0), label = c("a", "b", "b")) +
  stat_summary(fun.y=mean, geom="point", shape=23, size=2, na.rm = TRUE)
...
# Attributes
Based partially on material from [The Carpentries](https://carpentries.org/) made available under the [Creative Commons Attribution license](https://creativecommons.org/licenses/by/4.0/).  
[Five number summary](https://chemicalstatistician.wordpress.com/2013/08/12/exploratory-data-analysis-the-5-number-summary-two-different-methods-in-r-2/)
