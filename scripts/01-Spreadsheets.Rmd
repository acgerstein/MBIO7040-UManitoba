...
This lesson was created by [Aleeza Gerstein](https://microstatslab.ca) at the University of Manitoba. It is based largely on material from [The Carpentries](https://carpentries.org/) lesson on [Data Organization in Spreadsheets for Ecologists](https://datacarpentry.org/spreadsheet-ecology-lesson/). Made available under the [Creative Commons Attribution license](https://creativecommons.org/licenses/by/4.0/). [License](https://datacarpentry.org/R-genomics/LICENSE.html).
